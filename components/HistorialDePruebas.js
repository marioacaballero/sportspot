...
`}</Text>
        ...
        <View style={[styles.menInferior, styles.menInferiorLayout7]}>
          <View style={[styles.groupParent, styles.menInferiorLayout7]}>
            <Pressable
            ...
            <Pressable
              style={[styles.vector, styles.frameLayout9]}
            ...
            />
            <Pressable
              style={[styles.container, styles.frameLayout9]}
            ...
            <Pressable
              style={[styles.frame, styles.frameLayout9]}
          ...
          <Image
            style={[styles.menInferiorChild, styles.frameParentPosition6]}
            contentFit="cover"

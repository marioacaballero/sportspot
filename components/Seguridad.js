...
const Seguridad = () => {
  ...
  return (
    <View style={styles.seguridad}>
      ...
      >
        <Text style={[styles.gestionaTuCuentaContainer, styles.labelTypo1]}>
          {`GESTIONA TU `}CUENTA
        </Text>
      </View>
      <View style={[styles.seguridadInner, styles.seguridadInnerPosition]}>
        <View style={[styles.seguridadWrapper, styles.groupParentFlexBox1]}>
        ...
        <View style={styles.card1Wrapper}>
          <View style={styles.card1}>
            ...
            <View style={[styles.contraseaWrapper, styles.passwordIconLayout]}>
              <Text style={[styles.contrasea, styles.iconLayout1]}>
                Contraseña
              </Text>
            </View>
      ...
      <View style={[styles.menInferior, styles.menInferiorLayout1]}>
        <View style={[styles.groupParent, styles.menInferiorLayout1]}>
          <Pressable
          ...
          <Pressable
            style={[styles.vector, styles.frameLayout1]}

    ...
    <View style={styles.inicioPremium}>
      ...
      <View style={[styles.menInferiorParent, styles.menLayout]}>
        <View style={[styles.menInferior, styles.menLayout]}>
          <View style={[styles.groupContainer, styles.frameParentPosition7]}>
            <Pressable
            ...
            <Pressable
              style={[styles.vector, styles.frameLayout11]}
            ...
            />
            <Pressable
              style={[styles.container, styles.frameLayout11]}
            ...
            <Pressable
              style={[styles.frame, styles.frameLayout11]}

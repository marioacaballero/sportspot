...
ENCONTRADAS`}</Text>
        ...
        <View style={[styles.frameParent, styles.parentPosition2]}>
          <View style={styles.frameGroup}>
            ...
            >
              <Text style={styles.filtrosTypo3}>Filtros</Text>
              <Image
            ...
            >
              <Text style={styles.filtrosTypo3}>Ordenar por</Text>
              <Image
                style={styles.frameChild}
                contentFit="cover"
          ...
          <View style={styles.frameContainer}>
            <Pressable
              style={styles.unsplashon4qwhhjcemParentShadowBox1}
            ...
            >
              ...
              <View style={styles.frameView}>
                <View style={styles.ciclismoParent}>
                  <Text style={[styles.ciclismo, styles.textTypo5]}>
                    Ciclismo
                  </Text>
                  <Image
                    style={[styles.likeSpotsport, styles.containerLayout3]}
                    contentFit="cover"
...
`}</Text>
            ...
            <View
              style={[
                ...
                styles.unsplashon4qwhhjcemParentShadowBox1
              ]}
            >
              <Image
                style={styles.unsplashon4qwhhjcemIcon}
...
`}</Text>
        ...
        <View style={[styles.menInferior, styles.menInferiorPosition7]}>
          <View style={[styles.groupParent, styles.menInferiorPosition7]}>
            <Pressable
            ...
            />
            <Pressable
              style={[styles.container, styles.containerLayout3]}
...
const styles = StyleSheet.create({
  ...
  goingContainerFlexBox1: {
    marginTop: 10,
    alignSelf: 'stretch',
    textAlign: 'left'
  },
  unsplashon4qwhhjcemParentShadowBox1: {
    borderWidth: 1,

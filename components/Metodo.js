...
const Metodo = () => {
  ...
  return (
    <View style={styles.metodo}>
      ...
      <View style={[styles.menInferior, styles.menInferiorLayout2]}>
        <View style={[styles.groupParent, styles.menInferiorLayout2]}>
          <Pressable
          ...
          <Pressable
            style={[styles.vector, styles.frameLayout2]}
          ...
          />
          <Pressable
            style={[styles.container, styles.frameLayout2]}
          ...
          <Pressable
            style={[styles.frame, styles.frameLayout2]}

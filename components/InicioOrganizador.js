...
organizadores`}</Text>
      ...
      <View style={[styles.menInferior, styles.menInferiorPosition2]}>
        <View style={[styles.groupContainer, styles.menInferiorPosition2]}>
          <Pressable
          ...
          <Pressable
            style={[styles.vector, styles.frameLayout13]}
          ...
          />
          <Pressable
            style={[styles.container, styles.frameLayout13]}
          ...
          <Pressable
            style={[styles.frame, styles.frameLayout13]}

...
NOSOTROS`}</Text>
      ...
      <View style={styles.menInferior}>
        <View style={[styles.groupParent, styles.groupParentFlexBox2]}>
          <Pressable
          ...
          <Pressable
            style={[styles.vector, styles.frameLayout5]}
          ...
          />
          <Pressable
            style={[styles.container, styles.frameLayout5]}
          ...
          <Pressable
            style={[styles.frame, styles.frameLayout5]}
...
innovadora!`}{' '}
      ...
      <View
        style={[styles.trabajaConNosotrosFrame, styles.groupParentFlexBox2]}
      >

    ...
    >
      <View style={styles.frameParent}>
        ...
        <View style={styles.frameGroup}>
          <View style={[styles.nombreDeUsuarioWrapper, styles.wrapperFlexBox1]}>
            <Text style={[styles.nombreDeUsuario, styles.registrarse1Typo]}>
              Nombre de usuario
            </Text>
          </View>
          <View style={[styles.emailWrapper, styles.wrapperFlexBox1]}>
            <Text style={[styles.nombreDeUsuario, styles.registrarse1Typo]}>
              Email
            </Text>
          </View>
          ...
          <Pressable
            style={[styles.registrarseWrapper, styles.wrapperFlexBox1]}

  ...
  return (
    <View style={styles.cuenta}>
      ...
      <View style={[styles.menInferior, styles.menInferiorLayout4]}>
        <View style={[styles.groupParent, styles.menInferiorLayout4]}>
          <Pressable
          ...
          <Pressable
            style={[styles.vector, styles.frameLayout4]}
          ...
          />
          <Pressable
            style={[styles.container, styles.frameLayout4]}
          ...
          <Pressable
            style={[styles.frame, styles.frameLayout4]}

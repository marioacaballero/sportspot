...
const Inscrpcion = ({
    ...
    return (
        <ScrollView style={{ padding: 20, backgroundColor: "white", flex: 1 }} contentContainerStyle={{ paddingBottom: 50 }}>
            <Text style={{ marginBottom: 10, color: Color.violeta2, fontSize: 20, fontWeight: 600 }}>{`${route.params.title} -> Inscripcion`}</Text>
            <Text style={{ color: Color.sportsNaranja, marginBottom: 20, fontWeight: 600 }}>DATOS DEL DEPORTISTA</Text>
            <View style={{ width: '100%', flex: 1 }}>
                ...
                <Pressable style={styles.items} onPress={() => setCalendar(true)}>
                    ...
                    >
                        ...
                        {/* <Text
                            style={
                                user.birthDate || event.dateStart
                                    ? styles.helloTypoScroll
                                    : styles.helloTypoScroll2
                            }
                        >
                            {event.nacimiento || "Ingrese su fecha de nacimiento"}
                        </Text> */}
                        <TextInput
                            style={styles.helloTypoScroll}
                            value={event.nacimiento}
                            onChangeText={(value) => onValuesEvent('nacimiento', value)}
                ...
                <Pressable style={styles.items} onPress={openFrameContainer6}>
                    ...
                    >
                        <Text style={styles.text}>DNI/NIF/Pasaporte</Text>
                        {/* <Text
                            style={
                        ...
                        keyboardType='numeric'
                            ...
                            placeholder='DNI/NIF/Pasaporte'></TextInput>
                    </View>
                </Pressable>
                ...
                <View style={styles.items}>
                    ...
                    >
                        <Text style={styles.text}>Equipo/Club</Text>
                        <TextInput
                            style={styles.helloTypoScroll}
                            value={event.equipo}
                            onChangeText={(value) => onValuesEvent('equipo', value)}
                            placeholder="Equipo/Club"
                            placeholderTextColor={Color.violetaPlaceholder}
                        />
                    </View>
                </View>
                <View style={styles.items}>
                    ...
                    >
                        ...
                        <TextInput
                            style={styles.helloTypoScroll}
                            value={event.localidad}
                            onChangeText={(value) => onValuesEvent('localidad', value)}
                ...
                <View style={styles.items}>
                    ...
                    >
                        <Text style={styles.text}>Categoria de evento</Text>
                        <TextInput
                            style={styles.helloTypoScroll}
                            value={event.categoria}
                            onChangeText={(value) => onValuesEvent('categoria', value)}
                            placeholder="Categoria de evento"
                            placeholderTextColor={Color.violetaPlaceholder}
                        />
                    </View>
                </View>
                ...
                <Text style={{ color: Color.sportsNaranja, marginBottom: 20, fontWeight: 600 }}>DATOS DE CONTACTO</Text>
                ...
                <View style={styles.items}>
                    ...
                    >
                        <Text style={styles.text}>Precio inscripcion</Text>
                        <Text style={{ textAlign: "center", color: Color.sportsVioleta, fontSize: 16, fontWeight: 600 }}>{`${route.params.price ? route.params.price : 0}€`}</Text>
                    </View>
                </View>
                <TouchableOpacity
                    style={styles.submit}
